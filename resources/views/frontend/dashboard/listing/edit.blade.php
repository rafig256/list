...
<div class="my_listing">
        ...
        <form name="update_listing" id="update_listing" method="POST" action="{{route('user.listing.update',$listing->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                                ...
                                <div class="col-lg-11 mx-auto">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 row">
                                            <div class="upload col-6 mt-4 pr-md-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="title" class="form-control mb-4" id="title" placeholder="Title" value="{{$listing->title}}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="slug" class="form-control mb-4" id="slug" placeholder="slug" value="{{$listing->slug}}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 mt-3">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" name="address" class="form-control mb-4" id="address" placeholder="Address" value="{{$listing->address}}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="phone" class="form-control mb-4" id="phone" placeholder="Phone" value="{{$listing->phone}}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="email" class="form-control mb-4" id="email" placeholder="Email" value="{{$listing->email}}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="map_embed_code" class="form-control mb-4" id="map_embed_code" placeholder="Map Embed Code" value="{{$listing->map_embed_code}}">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="mt-2">
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="status" class="form-check-input" id="status_active" value="1" @checked($listing->status == 1)>
                                                                    <label class="form-check-label text-success ml-1 mr-1" for="status_active" >Active</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="status" class="form-check-input" id="status_inactive" value="0" @checked($listing->status == 0)>
                                                                    <label class="form-check-label text-danger ml-1 mr-1" for="status_inactive">Inactive</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 col-lg-4 col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="mt-2">
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="is_featured" class="form-check-input" id="is_featured_inactive" value="0" @checked($listing->is_featured == 0)>
                                                                    <label class="form-check-label text-danger ml-1 mr-1" for="is_featured_inactive">No</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="is_featured" class="form-check-input" id="is_featured_active" value="1" @checked($listing->is_featured == 1)>
                                                                    <label class="form-check-label text-success ml-1 mr-1" for="is_featured_active">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 col-lg-4 col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="mt-2">
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="is_verified" class=" form-check-input" id="is_verified_yes" value="1" @checked($listing->is_verified == 1)>
                                                                    <label for="is_verified_yes" class="text-success ml-1 mr-1">Yes</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="is_verified" class=" form-check-input" id="is_verified_no" value="0" @checked($listing->is_verified == 0)>
                                                                    <label for="is_verified_no" class="text-danger ml-1 mr-1">No</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group social-linkedin mb-3">
                                                ...
                                                <input type="text" class="form-control" name="linkedin_link" aria-label="Username" aria-describedby="linkedin" value="{{$listing->linkedin_link}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group social-tweet mb-3">
                                                ...
                                                <input type="text" class="form-control" name="x_link" aria-label="Username" aria-describedby="tweet" value="{{$listing->x_link}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group social-fb mb-3">
                                                ...
                                                <input type="text" class="form-control" name="facebook_link" aria-label="Username" aria-describedby="fb" value="{{$listing->facebook_link}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group social-github mb-3">
                                                ...
                                                <input type="text" class="form-control" name="instagram_link" aria-label="Username" aria-describedby="instagram" value="{{$listing->instagram_link}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group social-github mb-3">
                                                ...
                                                <input type="text" name="whatsapp_link" class="form-control" aria-label="Username" aria-describedby="whats up" value="{{$listing->whatsapp_link}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group social-github mb-3">
                                                ...
                                                <input type="text" name="website" class="form-control" aria-label="website" aria-describedby="website" placeholder="website" value="{{$listing->website}}">
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-11 mx-auto">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" id="description" placeholder="about listing" rows="10">{{$listing->description}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="seo_title" class="form-control mb-4" id="seo_title" placeholder="Seo Title" value="{{$listing->seo_title}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
            ...
            <div class="as-footer-container">
                <button type="submit" form="update_listing" class="btn btn-primary">Update </button>
                <button type="reset" form="update_listing" class="btn btn-warning">Reset All</button>
            </div>
        </form>
    </div>
@endsection
