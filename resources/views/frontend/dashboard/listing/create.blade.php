...
@section('content')
    <div class="my_listing">
        ...
        <form name="create_listing" id="create_listing" method="POST" action="{{route('user.listing.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="slug" class="form-control mb-4" id="slug" placeholder="slug" value="{{old('slug')}}" required>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="mt-2">
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="status" class="form-check-input" id="status_active" value="1" checked>
                                                                    <label class="form-check-label text-success ml-1 mr-1" for="status_active">Active</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="status" class="form-check-input" id="status_inactive" value="0">
                                                    ...
                                                    <div class="col-sm-6 col-lg-4 col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="mt-2">
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="is_featured" class="form-check-input" id="is_featured_inactive" value="0" checked>
                                                                    <label class="form-check-label text-danger ml-1 mr-1" for="is_featured_inactive">No</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="is_featured" class="form-check-input" id="is_featured_active" value="1">
                                                    ...
                                                    <div class="col-sm-6 col-lg-4 col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="mt-2">
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" name="is_verified" class=" form-check-input" id="is_verified_yes" value="1" checked>
                                                                    <label for="is_verified_yes" class="text-success ml-1 mr-1">Yes</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                <input type="radio" name="is_verified" class=" form-check-input" id="is_verified_no" value="0" >
            ...
            <div class="as-footer-container">
                <button type="submit" form="create_listing" class="btn btn-primary">Save </button>
                <button type="reset" form="create_listing" class="btn btn-warning">Reset All</button>
            </div>
        </form>
    </div>
@endsection
