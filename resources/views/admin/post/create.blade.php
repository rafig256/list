    ...
    <div class="account-settings-container layout-top-spacing">
        ...
        <div class="account-content">
            <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                <form id="addPost" action="{{route('admin.post.store')}}" enctype="multipart/form-data" method="POST" class="">
                    @csrf
                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row mt-2">
                                                                    <input type="radio" name="is_popular" class=" mb-4 " id="is_popular_inactive" value="0" checked><label for="is_popular_inactive" class="text-danger ml-1 mr-1">No</label>
                                                                    <input type="radio" name="is_popular" class=" mb-4 ml-5" id="is_popular_active" value="1" > <label for="is_popular_active" class="text-success ml-1 mr-1">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-11 mx-auto">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" id="description" placeholder="start writing" rows="10">{{old('description')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="account-settings-footer">
            ...
            <div class="as-footer-container">
                ...
                <button type="submit" form="addPost" class="btn btn-primary">Save </button>
