            ...
            <div class="account-settings-container layout-top-spacing">
                <div class="account-content">
                    <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                        <div class="">
                            <form id="add-role" method="POST" action="{{route('admin.role.update' , $role->id)}}">
                                @csrf
                                @method('PUT')
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="role" class="form-control mb-4" id="role" value="{{$role->name}}" required>
                                                                        </div>
                                                                    </div>
                                                                    <hr>
                                                                    <div class="col-md-12">
                                                                                ...
                                                                                @foreach($subPermissions as $permission)
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <label class="switch s-icons s-outline s-outline-primary mr-2">
                                                                                            <input type="checkbox" name="permissions[]" @checked(in_array($permission->name , $rolePermissions)) value="{{$permission['name']}}">
