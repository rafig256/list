...
<g>
    ...
    <circle style="fill:#FFFFFF;" cx="43" cy="27.5" r="3"/>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="icon-pills-icon-tab" data-toggle="pill" href="#icon-pills-appearance" role="tab" aria-controls="icon-pills-appearance" aria-selected="false">
                ...
                <div class="tab-content" id="icon-pills-tabContent">
                    ...
                    @include('admin.setting.section.appearance')
                </div>
            </div>
        </div>
    </div>
