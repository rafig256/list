            ...
            <div class="widget-header p-3">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-4 col-4">
                        <a href="{{route('admin.blog-category.create')}}" class="btn btn-primary mt-2 float-right">Add New blog</a>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                                ...
                                <td>{!! $blog_category->status ? '<span class="badge badge-success"> Active </span>' : '<span class="badge badge-danger"> DeActive </span>' !!}</td>
                                <td class="text-center">
                                    <ul class="table-controls">
                                        <li><a href="{{route('admin.blog-category.edit',$blog_category->id)}}"  data-toggle="tooltip" data-placement="top" title="Edit" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
                                        <li><form action="{{route('admin.blog-category.destroy',$blog_category->id)}}" method="post">
                                            @csrf
                                            @method('DELETE')
