    ...
    <div class="account-settings-container layout-top-spacing">
        ...
        <div class="account-content">
            <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                <form id="add-user" action="{{route('admin.user.store')}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-2 col-lg-12 col-md-4">
                                                    <div class="upload mt-4 pr-md-4">
                                                        <input type="file" name="avatar" id="input-file-max-fs" class="dropify" data-default-file="{{asset('default/avatar.png')}}" data-max-file-size="1M" required/>
                                                        <p class="mt-2"><i class="flaticon-cloud-upload mr-1"></i> Add Avatar</p>
                                                    </div>
                                                    <hr>
                                                    <div class="upload mt-4 pr-md-4">
                                                        <input type="file" name="banner" id="input-file-max-fs" class="dropify" data-default-file="{{asset('default/default_upload.jpg')}}" data-max-file-size="1M" required/>
                                                        <p class="mt-2"><i class="flaticon-cloud-upload mr-1"></i> Add Banner Image</p>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="name" class="form-control mb-4" id="name" placeholder="Title" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="phone"> Phone <span class="text-danger">*</span> </label>
                                                                    <input type="text" name="phone" class="form-control mb-4" id="phone" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="address" class="form-control mb-4" id="address" placeholder="Address" required>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="input-group social-linkedin mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="in_link" aria-label="Username" aria-describedby="linkedin" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group social-tweet mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="x_link" aria-label="Username" aria-describedby="tweet">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="input-group social-fb mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="fb_link" aria-label="Username" aria-describedby="fb" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group social-github mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="instagram_link" aria-label="Username" aria-describedby="instagram" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group social-github mb-3">
                                                        ...
                                                        <input type="text" name="wa_link" class="form-control" aria-label="Username" aria-describedby="whats up">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group social-github mb-3">
                                                        ...
                                                        <input type="text" name="website" class="form-control" aria-label="website" aria-describedby="website" placeholder="website">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-11 mx-auto">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="about" id="description" placeholder="about" rows="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="account-settings-footer">
            ...
            <div class="as-footer-container">
                ...
                <button type="reset" form="add-user" class="btn btn-warning">Reset All</button>
                <button type="submit" form="add-user" class="btn btn-primary">Save </button>
