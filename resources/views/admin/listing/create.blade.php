                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group social-linkedin mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="linkedin_link" aria-label="Username" aria-describedby="linkedin" >
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group social-fb mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="facebook_link" aria-label="Username" aria-describedby="fb">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group social-github mb-3">
                                                    ...
                                                    <input type="text" name="whatsapp_link" class="form-control" aria-label="Username" aria-describedby="whats up" >
                                                </div>
                                            </div>
