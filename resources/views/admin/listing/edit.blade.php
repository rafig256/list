    ...
    <div class="account-settings-container layout-top-spacing">
        ...
        <div class="account-content">
            <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                <form id="listing" action="{{route('admin.listing.update',$listing->id)}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('PUT')
                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="slug" class="form-control mb-4" id="slug" value="{{$listing->slug}}" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        <input type="radio" name="status" class=" mb-4" id="status_active" value="1" @checked($listing->status == 1)> <label for="status_active" class="text-success ml-1 mr-1">Active</label>
                                                                        <input type="radio" name="status" class=" mb-4 ml-5" id="status_inactive" value="0" @checked($listing->status == 0)><label for="status_inactive" class="text-danger ml-1 mr-1">Inactive</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        <input type="radio" name="is_featured" class=" mb-4 " id="is_featured_inactive" value="0" @checked($listing->is_featured == 0)><label for="is_featured_inactive" class="text-danger ml-1 mr-1">No</label>
                                                                        <input type="radio" name="is_featured" class=" mb-4 ml-5" id="is_featured_active" value="1" @checked($listing->is_featured == 1)> <label for="is_featured_active" class="text-success ml-1 mr-1">Yes</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        <input type="radio" name="is_verified" class=" mb-4" id="is_verified_yes" value="1" @checked($listing->is_verified == 1)> <label for="is_verified_yes" class="text-success ml-1 mr-1">Yes</label>
                                                                        <input type="radio" name="is_verified" class=" mb-4 ml-5" id="is_verified_no" value="0" @checked($listing->is_verified == 0)><label for="is_verified_no" class="text-danger ml-1 mr-1">No</label>
                                                                    </div>
                                                                </div>
                                                            </div>
